...
describe("functions", () => {
  test('define a custom function called "myFunc"', () => {
  ...
  test("assign a function to a variable called myCustomFunction", () => {
  ...
  test('define a function with the "arrow function" shorthand', () => {
  ...
  test("can invoke(call) the function myCustomFunction 4 times", () => {
  ...
  test("modify myCustomFunction so that it returns a value of 42", () => {
    // functions not only can execute code but return a value from the executed code
  ...
  test("pass an argument to a function myCustomFunction and have it return that value", () => {
    ...
    function myCustomFunction(todaysVar) {
      return todaysVar;
    }
    expect(myCustomFunction(333)).toBe(333);
  });

  test("addFunc can add 1 and 2 to get a return value of 3", () => {
    ...
    expect(addFunc(3, 2)).toBe(5);
  });

  test("addFunc can add numbers", () => {
