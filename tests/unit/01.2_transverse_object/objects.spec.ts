...
describe("transverse objects and object reference", () => {
  ...
  test('there is a variable "pizza" that will be an empty object', () => {
    expect(pizza).not.toBeNull();
  });

  test('pizza object has property size and size is set to a string "large"', () => {
    expect(pizza.size).not.toBeNull();
    expect(pizza.size).toBe("large");
  });

  test('pizza object has property crust and crust is set to a string "thin"', () => {
    expect(pizza.crust).not.toBeNull();
    expect(pizza.crust).toBe("thin");
  });

  test('pizza object has property topping and topping is set to a string "pepperoni"', () => {
    expect(pizza.topping).not.toBeNull();
    expect(pizza.topping).toBe("pepperoni");
  });

  test("pizza object has a method cook", () => {
  ...
  test("pizza object has property customer and customer is set to an object with a name property", () => {
